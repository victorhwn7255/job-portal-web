...
export default function UserProfilePage() {
  ...
  return (
    <div>
      ...
      {userData && <>
      {/* profile */}
      <div className='w-[400px] px-4 py-9 bg-white dark:bg-blue-900 dark:border-blue-900 dark:brightness-110 shadow-lg border border-lightGray rounded-lg mx-auto mt-16 flex items-center justify-center space-x-8'>
        <Image 
          src={profile} 
          alt="Profile Pic" 
          width={90}
        ...
        <div className='flex flex-col items-start space-y-2'>
          <h3 className='text-lg font-medium text-grayClassic800 dark:text-grayClassic50'>{userData?.name}</h3>
      ...
      <div className='w-[90%] lg:w-[65%] mx-auto mt-20'>
        ...
        <div className=' bg-grayClassic100 dark:bg-bgDark3 shadow-sm rounded-lg py-5 px-8 flex items-center justify-between mt-3'>
          <div className='flex flex-col items-start space-y-2'>
      ...
      <div className='w-[90%] lg:w-[65%] mx-auto mt-20'>
        ...
        <div className='bg-white dark:bg-bgDark2 dark:border-bgDark2 shadow-lg border border-lightGray rounded-lg px-6 py-6 mt-4 flex items-center space-x-6'>
          ...
          <div className='w-[85%] flex items-center justify-between'>
            ...
            <p className='font-light text-grayClassic600 dark:text-grayClassic300 text-sm'>Attained in {userData?.yearAttained}</p>
          </div>
        </div>
      </div>
      {/* Work Experience */}
      <div className='w-[90%] lg:w-[65%] mx-auto mt-20 mb-40'>
        ...
        <div className='bg-white dark:bg-bgDark2 dark:border-bgDark2 shadow-lg border border-lightGray rounded-lg px-6 py-6 mt-4 flex items-center space-x-6'>
          ...
          <div className='w-[85%] flex items-center justify-between'>
            ...
            <p className='font-light text-grayClassic600 dark:text-grayClassic300 text-sm'>{userData?.startDate} - {userData?.endDate}</p>
          </div>
        </div>
      </div>
      </>}
