        ...
        <div className='flex flex-col justify-center items-start w-[90%] lg:w-[65%] px-3'>
          <div className='flex items-center space-x-6'>
            ...
            <div className='flex flex-col items-start space-y-2'>
              <p className='text-xs md:text-sm text-grayClassic600'>Application for</p>
              <h2 className='text-base md:text-lg font-semibold'>Front End Developer</h2>
        ...
        >
          ...
          <div className='w-full px-9 py-12 bg-white shadow-lg rounded-xl border border-lightGray flex flex-col'>
            <div className='flex items-center justify-between'>
              <div className='flex flex-col items-start space-y-2'>
                ...
                <p className='text-xs md:text-base font-light text-grayClassic700'>Include one resume with your application</p>
              </div>
              <div className='uploadFile'>
                <button className='uploadBtn flex items-center space-x-2'>
                  ...
                  <input 
                    ...
                    required 
                    value={resume} 
                    onChange={(e) => {setResume(e.target.value); setResumeUpdateDate(resumeUpdateDate)}} />
                </button>
              </div>
            </div>
            {resume && <div className='w-[100%] bg-grayClassic100 h-[70px] rounded-xl mt-8 px-6 py-4 flex items-center justify-between'>
              <div className='flex flex-col items-start space-y-1 overflow-hidden'>
                <p className='text-sm font-medium'>{resume}</p>
                <p className='text-xs font-light text-grayClassic700'>updated on {today}</p>
              </div>
              <button onClick={() => setResume('')}>
                <MdDelete size={25} className='text-grayClassic700 hover:text-red-500 duration-200'/>
              </button>
            </div>}
          </div>
          ...
          <div className='w-full px-9 py-12 pb-20 bg-white shadow-lg rounded-xl border border-lightGray flex flex-col items-start mt-12'>
            <div className='flex flex-col items-start space-y-2'>
              ...
              <p className='text-xs md:text-base font-light text-grayClassic700'>Select your highest qualification</p>
            </div>
            <div className='flex flex-col lg:flex-row items-start justify-start space-x-0 space-y-10 lg:space-y-0 lg:space-x-3 mt-8'>
              ...
              <div className='w-[450px] space-y-10'>
                ...
                <div className='flex flex-col justify-start space-y-3 w-[60%] md:w-[90%]'>
                  <label className='text-grayClassic700 font-medium text-sm md:text-base'>Qualification Type</label>
                  <Select 
                    options={education} 
                    onChange={(option) => {setqualificationType(option.label)}}
                  />
                </div>
                {/* name of school */}
                <div className='flex flex-col justify-start space-y-3 w-[60%] md:w-[90%]'>
                  <label htmlFor='school' className='text-grayClassic700 font-medium text-sm md:text-base'>Name of School</label>
                  <input 
                    type='text' 
              ...
              <div className='w-[450px] space-y-10'>
                ...
                <div className='flex flex-col justify-start space-y-3'>
                  <label htmlFor='attainedyear' className='text-grayClassic700 font-medium text-sm md:text-base'>Year Attained</label>
                  <input 
                    type='text' 
                    placeholder='YYYY'
                ...
                {/* qualification name */}
                <div className='flex flex-col justify-start space-y-3 w-[60%] md:w-[90%]'>
                  <label htmlFor='qualification' className='text-grayClassic700 font-medium text-sm md:text-base'>Qualification Name</label>
                  <input 
                    type='text' 
          ...
          <div className='w-full px-9 py-12 pb-20 bg-white shadow-lg rounded-xl border border-lightGray flex flex-col items-start mt-12'>
            <div className='flex flex-col items-start space-y-2'>
              ...
              <p className='text-xs md:text-base font-light text-grayClassic700'>Share your relevant work experience</p>
            </div>
            <div className='flex flex-col lg:flex-row items-start justify-start space-x-0 space-y-10 lg:space-y-0 lg:space-x-3 mt-8'>
              {/* col 1 */}
              <div className='w-[450px] space-y-10'>
                {/* company name */}
                <div className='flex flex-col justify-start space-y-3 w-[60%] md:w-[90%]'>
                  <label id='companyname' className='text-grayClassic700 font-medium text-sm md:text-base'>Company Name</label>
                  <input 
                    type='text' 
                ...
                {/* employment type */}
                <div className='flex flex-col justify-start space-y-3 w-[60%] md:w-[90%]'>
                  <label htmlFor='school' className='text-grayClassic700 font-medium text-sm md:text-base'>Employment Type</label>
                  <Select 
                    options={employmentTypes} 
                    onChange={(option) => {setEmploymentType(option.label)}}
                  />
                </div>
              </div>
              {/* col 2 */}
              <div className='w-[450px] space-y-10'>
                {/* job title */}
                <div className='flex flex-col justify-start space-y-3 w-[60%] md:w-[90%]'>
                  <label htmlFor='jobtitle' className='text-grayClassic700 font-medium text-sm md:text-base'>Job Title</label>
                  <input 
                    type='text' 
                ...
                {/* employment period */}
                <div className='flex flex-col justify-start space-y-3'>
                  <label className='text-grayClassic700 font-medium text-sm md:text-base'>Employment Period</label>
                  <div className='flex flex-col md:flex-row items-start md:items-center space-x-0 md:space-x-3 space-y-3 md:space-y-0'>
                    <input 
                      type='date' 
                      className='bg-grayClassic100 px-5 text-grayClassic400 py-2 rounded-lg text-sm outline-none w-[60%] md:w-[40%]' 
                      id="startdate"
                      value={startDate}
            ...
            {/* optional */}
            <label className='text-grayClassic700 font-medium mt-10 text-sm md:text-base'>Workd Description (optional)</label>
            <textarea 
          ...
          <div className='w-full px-9 py-12 bg-white shadow-lg rounded-xl border border-lightGray flex flex-col items-start mt-12'>
            <div className='flex flex-col items-start space-y-2'>
              ...
              <p className='text-xs md:text-base font-light text-grayClassic700'>Add the skills you possess</p>
            </div>
            <div className='mt-5 flex items-center space-x-3 lg:space-x-5 flex-wrap space-y-2 lg:space-y-0 '>
              {skills.map((eachSkill, idx) => (
                <button 
                  key={idx} 
                  className={`${selectedSkills.includes(eachSkill) ? 'bg-lightBlue text-grayClassic50 hover:bg-blue-800 dark:text-grayClassic50' : 'bg-grayClassic100 hover:bg-gray-200 dark:text-gray-800'} px-5 py-2 rounded-xl duration-200 flex items-center space-x-1`}
                  onClick={() => {
                  ...
                  type="button"
                >
                  <span className={`${selectedSkills.includes(eachSkill) ? 'block' : 'hidden'}`}><AiFillCheckCircle /></span>
                  <p>{eachSkill}</p>
                </button>
              ))}
            </div>
