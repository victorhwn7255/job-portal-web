    ...
    <div className='flex justify-center pt-[4rem]'>
      <div className=''>
          ...
          <Link href="/" className='flex flex-col items-center space-y-2 group'>
            <HiOfficeBuilding size={45} className="text-lightBlue dark:text-grayClassic50 ring-2 rounded-full ring-lightBlue p-[9px] group-hover:scale-95 group-hover:text-white group-hover:ring-blue-800 group-hover:bg-blue-800 duration-200" />
          ...
          <div className='flex flex-col justify-center items-center mt-14 w-full space-y-3'>
            ...
            <button className='flex items-center justify-center space-x-2 bg-slate-100 dark:bg-slate-900 w-[75%] py-3 rounded-full hover:bg-slate-200 duration-200 hover:shadow-md dark:hover:brightness-125'>
              <FcGoogle size={18} />
              <p className='text-xs md:text-sm text-grayClassic700 dark:text-grayClassic100'>Continue with Google</p>
            </button>
            <button className='flex items-center justify-center space-x-2 bg-slate-100 dark:bg-slate-900 w-[75%] py-3 rounded-full hover:bg-slate-200 duration-200 hover:shadow-md dark:hover:brightness-125'>
              <BsLinkedin size={18} className='text-lightBlue dark:text-sky-500' />
              <p className='text-xs md:text-sm text-grayClassic700 dark:text-grayClassic100'>Continue with LinkedIn</p>
            </button>
          </div>
        </div>
    </div>
