      ...
      <div className="container flex justify-between items-center mx-auto">
        ...
        <div className="flex items-center space-x-3 md:space-x-4 lg:space-x-6 relative">
          ...
          <Link href="/signup" className="hidden md:flex">
            <p className="text-lightBlue dark:text-grayClassic50 hover:text-blue-800 font-medium text-sm md:text-base hover:underline underline-offset-[6px] decoration-wavy duration-200">
              Sign Up
            </p>
          </Link>
          {/* login */}
